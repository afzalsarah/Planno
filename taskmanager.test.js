    ...
    test("object exists", () => {
        ...
        testTm.cardArr = [];
        testTm.addcard("shopping", "gotocoles", "Sarah", "03-09-2020", "to do");
    ...
    test("HTML element is added to page ", () => {
        ...
        testTm.addcard("Sprint Plan 2", "Make a wireframe", "Abeer", "03-09-2020", "to do");
    ...
    test("card id should matches the task to update", () => {
        ...
        const testTm = new CardManager();
        testTm.cardArr = [];
        testTm.updateTask("nCard1", "carwash", "gotocarwash", "Sarah", "04-09-2020", "to do");
    ...
    test("checking for updated values", () => {
        ...
        const testTm = new CardManager();
        testTm.cardArr = [];
        testTm.addcard("nCard1", "Grocery", "gotoWoolies", "Abeer", "02-09-2020", "to do later");
        testTm.updateTask("nCard1", "carwash", "gotocarwash", "Sarah", "02-09-2020", "to do");
        ...
        expect(testTm.cardArr[0].assignee).toBe("Sarah");
    ...
    test("after deletion the array lenght should be reduced by one", () => {
        const testTm = new CardManager();
        testTm.cardArr = [];
        testTm.addcard("nCard1", "Grocery", "gotoWoolies", "Sarah", "02-09-2020", "to do later");
        testTm.addcard("nCard2", "CarWash", "gotoShell", "Abeer", "02-09-2020", "to do");
        testTm.deletFunc("nCard1");
        expect(testTm.cardArr.length).toBe(1);
    });
    h